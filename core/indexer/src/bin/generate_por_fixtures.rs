...
const CROSS_BLOCK_SEED_A: u64 = 200;
const CROSS_BLOCK_SEED_B: u64 = 201;
...
fn main() -> Result<()> {
    ...
    let fixtures = PorProofFixtures {
        invalid_proof_hex,
        cross_block_agg_hex,
        cross_block_seed_a: CROSS_BLOCK_SEED_A,
        cross_block_seed_b: CROSS_BLOCK_SEED_B,
...
fn generate_cross_block_agg_hex() -> Result<String> {
    ...
    let challenge_a = Challenge::new(
        ...
        block_height,
        100,
        valid_seed_field(CROSS_BLOCK_SEED_A).field,
        "node_1".to_string(),
    );
    let challenge_b = Challenge::new(
        ...
        block_height,
        100,
        valid_seed_field(CROSS_BLOCK_SEED_B).field,
        "node_1".to_string(),
    );
