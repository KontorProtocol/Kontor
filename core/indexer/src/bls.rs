...
/// Set of verified signer_ids returned by [`verify_aggregate`].
pub type VerifiedSigners = HashSet<u64>;
...
pub async fn verify_aggregate(runtime: &mut Runtime, insts: &Insts) -> Result<VerifiedSigners> {
