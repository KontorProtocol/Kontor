...
CREATE INDEX IF NOT EXISTS idx_signer_registry_bls_pubkey ON signer_registry (bls_pubkey);
...
CREATE INDEX IF NOT EXISTS idx_signer_nonces_signer_id ON signer_nonces (signer_id);
