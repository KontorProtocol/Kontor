...
/// returns their NodeInfo node_id strings (the signers' signer_id) in join order.
async fn join_n_distinct(
    runtime: &mut Runtime,
    agreement_id: &str,
    n: usize,
) -> Result<Vec<String>> {
