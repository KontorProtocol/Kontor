...
//! value with N `#[index]` fields therefore locks the value's deposit plus one
//! per live index entry; a hot, frequently-rewritten indexed field is the costliest
//! shape. This is intentional (index rows are real, refundable state), but authors
