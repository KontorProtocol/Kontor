...
import installer from './NativeKontorMobile';
...
export * from './generated/kontor_mobile';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as kontor_mobile from './generated/kontor_mobile';
...
if (!initialized) {
  kontor_mobile.default.initialize();
  initialized = true;
}
