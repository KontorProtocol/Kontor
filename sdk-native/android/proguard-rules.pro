...
#
# The JSI Turbo Module reaches native code through JNI: KontorSdkNativeModule's
...
-keep class com.kontor.sdknative.KontorSdkNativeModule { *; }
-keep class com.kontor.sdknative.KontorSdkNativePackage { *; }
