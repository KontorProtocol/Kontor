...
async fn test_taproot_transaction_invalid_token_data() -> Result<()> {
    ...
    let malformed_tap_script = build_tapscript(serialized_malformed_token_balance, &internal_key)?;
...
async fn test_taproot_transaction_wrong_internal_key() -> Result<()> {
    ...
    let tap_script = build_tapscript(serialized_token_balance.clone(), &internal_key)?;
    ...
    let malformed_tap_script = build_tapscript(serialized_token_balance, &buyer_internal_key)?;
...
async fn test_taproot_transaction_without_checksig() -> Result<()> {
    ...
    let tap_script =
        build_tapscript_without_checksig(serialized_token_balance, &internal_key)?.into_script();
...
async fn test_taproot_transaction_with_wrong_internal_key_without_checksig() -> Result<()> {
    ...
    let tap_script =
        build_tapscript_without_checksig(serialized_token_balance.clone(), &internal_key)?
            .into_script();
    ...
    let malformed_tap_script =
        build_tapscript_without_checksig(serialized_token_balance, &buyer_internal_key)?;
...
fn build_tapscript_without_checksig(
...
fn build_tapscript(
    ...
    let tap_script = build_tapscript_without_checksig(serialized_token_balance, internal_key)?
