...
// Types are generated by wit-bindgen at the crate root
// No need to import them - they're already in scope

// Temporarily disabled due to resource type conflicts
// interface!(name = "token_dyn", path = "token/wit");

// SplitResult is now imported from built-in assets

// Placeholder module for token_dyn until interface macro is fixed
mod token_dyn {
    use super::*;
    
    pub type Balance = crate::assets::Balance;
    pub type SplitResult = crate::assets::SplitResult;
